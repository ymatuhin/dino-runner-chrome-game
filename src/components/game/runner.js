 ...
 * @export
 */
export function Runner(outerContainerId, myConfig) {
...
Runner.prototype = {
  ...
  init() {
    ...
    this.slowSpeedCheckboxLabel.className = "hidden slow-speed-option";
